...
You can add prop packs in the tool memory and make one of them default, this will auto restore pack when you open the tool,
also it's faster to switch between multiple packs that you often use by pressing Restore selected button

'Make default' checkbox makes selected prop pack default, and it will be auto-restored if 'Restore default on tool startup' checkbox is active.<br>
